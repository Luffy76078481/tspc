            ...
            for (let index = 0; index < oriData.length; index++) {
                ...
                gameEle.push(
                    <div className="gameContent" key={index}>
                        <p className="gcTitle">
                            <span>{SD[0]}</span>
                            <span className="gcTred">保险投注(免单)</span>
                        </p>
                        <p className="gcGameName">{SD[1]}</p>
                        <div className="gcVSbox">
                            <div className="vsL">{SD[2]}</div>
                            <div className="vsC">VS</div>
                            <div className="vsR">{SD[3]}</div>
                        </div>
                        <p className="gcBtoom">
                            <span className="gcbL">{SD[4]}</span>
                            <span className="gcbR">{SD[5]}</span>
                        </p>
                    </div>
                )
            }
            ...
            <div className="HomePage" ref="homepage">
                ...
                <div className="homeBody">
                    ...
                    <div className="sportBox">
                        ...
                        <div className="box">
                            <h1>掌上更直观 玩法更齐全</h1>
                            <h3>立即下载专属<span>APP</span></h3>
                            <div className='btns'>
                                <button onClick={()=>{window.open(this.props.remoteSysConfs.channel_push_url)}}>下载专属APP</button>
                            </div>
                    ...
                    <div className='sportBox'>
                        <div className='box'>
                            ...
                            <div className='boxContent'>
                                <div className='boxText'>
                                    <p>亚博上线以来就与多项国家级大型电子竞技赛事及赛事厂商达成了合作。为</p>
