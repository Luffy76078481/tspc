  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        // "globalHelper": path.resolve(__dirname, "./config/config_helper"), // config_helper
        ...
        // "pui": path.resolve(__dirname, "./src/template/comm/publicUI/Pui.js"), //公共UI小模块
        "baseClass": paths.appBaseClass, //公共方法
      },
      ...
      alias: {
        ...
        "@": paths.appCommon, //公共方法
        "components": paths.appComponents, //公用组件
            ...
            // extensions .module.scss or .module.sass
            {
              ...
              use: getStyleLoaders(
                ...
                options: {
                  ...
                  resources: ['./src/common/style/theme.scss']
                }
              }),
              // Don't consider CSS imports dead code even if the
              // containing package claims to have no side effects.
